...
public class Layar extends JFrame {
     ...
     */
    public synchronized final int getNHantu() {
        return nHantu;
    }
     ...
     */
    public synchronized final int getNBawangPutih() {
        return nBawangPutih;
    }
     ...
     */
    public synchronized final int getNPsiko() {
        return nPsiko;
    }
     ...
     */
    public synchronized final int getNPsikiater() {
        return nPsikiater;
    }
     ...
     */
    public synchronized final int getNCenayang() {
        return nCenayang;
    }
     ...
     */
    public synchronized final void setnBawangPutih(final int z) {
        nBawangPutih = z;
    }
     ...
     * @param z nilai yang akan ditetapkan.
     */
    public synchronized final void setnPsiko(final int z) {
        nPsiko = z;
    }
     ...
     * @param z nilai yang akan ditetapkan.
     */
    public synchronized final void setnPsikiater(final int z) {
        nPsikiater = z;
    }
     ...
     * @param z nilai yang akan ditetapkan.
     */
    public synchronized final void setnCenayang(final int z) {
        nCenayang = z;
    }
     ...
     * @param z nilai yang akan ditetapkan.
     */
    public synchronized final void setnHantu(final int z) {
        nHantu = z;
    }
     ...
     */
    public synchronized final void setID(final String iD, final int x, final int y) {
     ...
     */
    public synchronized final boolean isBawangExist(final int x, final int y) {
        boolean b = false;
        if (x < boardsize && y < boardsize) {
            String tmp;
            tmp = m[x][y].s[1];
     ...
     * @param y posisi y makhluk.
     */
    public synchronized final void removeID(final String id, final int x, final int y) {
        if (x < boardsize && y < boardsize) {
     ...
     * makhluk.
     */
    public synchronized final boolean isEmpty(final int x, final int y) {
        return (m[x][y].n == 0);
    }
     ...
     */
    public synchronized final void printIsi(final int x, final int y) {
        String tmp1, tmp2;
     ...
     * @return ID Makhluk.
     */
    public synchronized final String getID(final int x, final int y, final int n) {
     ...
     */
    public synchronized final void drawLayar() {
     ...
     */
    public synchronized final void printToFile() throws IOException {
     ...
     * @throws IOException exception on input output.
     */
    public synchronized final void actionPerformed(final ActionEvent e) throws IOException {
